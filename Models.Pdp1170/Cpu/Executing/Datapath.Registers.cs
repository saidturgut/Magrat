...
{
    private readonly Register[] CoreRegisters =  new Register[coreRegisters];
    private readonly Register[] TemporaryLatches =  new Register[tempLatches];
    ...
    private Register PointCore(Pointer pointer)
        => CoreRegisters[(byte)pointer];
    private Register PointLatch(Pointer pointer)
