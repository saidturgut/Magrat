...
public partial class Microcode
{
    ...
    [
        ..LOAD_PAIR_IMM(WZ),
        ..cond ? [REG_COMMIT(Pointer.FR, Pointer.TMP), COND_COMPUTE(State.FETCH, (Condition)aa_XXX_aaa)] : NONE,
        ..JUMP_TO_PAIR(WZ),
    ];
    ...
    [
        ..READ_IMM,
        ..condition is not Condition.NONE ? [REG_COMMIT(Pointer.FR, Pointer.TMP), COND_COMPUTE(State.FETCH, condition)] : NONE,
        ..JUMP_INDEXED,
    ];
    ...
    [
        ..READ_IMM,
        REG_COMMIT(Pointer.FR, Pointer.W),
        ...
        REG_COMMIT(Pointer.W, Pointer.FR),
