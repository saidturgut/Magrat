...
public class Logger : ILogger
{
    ...
    {        
        ...
        return [
            ...
            $"D: {Log.Hex(registers[(byte)Pointer.B].Get())}   E: {Log.Hex(registers[(byte)Pointer.C].Get())}",
            
            $"I: {Log.Hex(registers[(byte)Pointer.B].Get())}   R: {Log.Hex(registers[(byte)Pointer.C].Get())}",
